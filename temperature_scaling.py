...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("./right_open_llama_3b_rlhf_rm_temperature1.37_2epoch_2e-05__temperature_last_checkpoint").to(device)
