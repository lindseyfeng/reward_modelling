...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("./right_open_llama_3b_rlhf_rm_logit_bin_temperature_2e-05__temperature_last_checkpoint").to(device)
